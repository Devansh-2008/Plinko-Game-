...
function draw() {
  ...
  textSize(25)
  fill("white")
  text(500 + score, width-450, 425)

  noStroke();
  textSize(25)
  fill("white")
  text(250 + score, width-370, 425)

  noStroke();
  textSize(25)
  fill("white")
  text(100 + score, width-290, 425)

  noStroke();
  textSize(25)
  fill("white")
  text(100 + score, width-210, 425)

  noStroke();
  textSize(25)
  fill("white")
  text(250 + score, width-130, 425)

  noStroke();
  textSize(25)
  fill("white")
  text(500 + score, width-50, 425)
